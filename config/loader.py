...
def load_config(config_path: str = "config/config.yaml", env_file: str = ".env") -> dict:
    ...
    _config["env"]["oanda_api_token"]   = os.getenv("OANDA_API_TOKEN", "")
    _config["env"]["oanda_account_id"]  = os.getenv("OANDA_ACCOUNT_ID", "")
    _config["env"]["oanda_environment"] = os.getenv("OANDA_ENVIRONMENT", "practice")
